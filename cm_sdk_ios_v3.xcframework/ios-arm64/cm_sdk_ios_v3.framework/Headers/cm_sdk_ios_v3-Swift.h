...
- (BOOL)hasUserChoice SWIFT_WARN_UNUSED_RESULT;
- (BOOL)hasPurposeConsentWithId:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
- (BOOL)hasVendorConsentWithId:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)exportCMPInfo SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)getAllPurposesIDs SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)getEnabledPurposesIDs SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)getDisabledPurposesIDs SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)getAllVendorsIDs SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)getEnabledVendorsIDs SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)getDisabledVendorsIDs SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface CMPManager (SWIFT_EXTENSION(cm_sdk_ios_v3))
- (void)checkWithServerAndOpenIfNecessaryWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)openConsentLayerWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)jumpToSettingsWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)checkIfConsentIsRequiredWithCompletion:(void (^ _Nonnull)(BOOL))completion;
...
- (nonnull instancetype)initWithObjcPosition:(CMPPosition * _Nonnull)objcPosition objcBackgroundStyle:(CMPBackgroundStyle * _Nonnull)objcBackgroundStyle cornerRadius:(CGFloat)cornerRadius respectsSafeArea:(BOOL)respectsSafeArea allowsOrientationChanges:(BOOL)allowsOrientationChanges OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) CMPPosition * _Nonnull halfScreenTop;)
+ (CMPPosition * _Nonnull)halfScreenTop SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) CMPPosition * _Nonnull halfScreenBottom;)
+ (CMPPosition * _Nonnull)halfScreenBottom SWIFT_WARN_UNUSED_RESULT;
